...
string names[5] = { "Àíäðåé", "Òèìóð", "Ïåòð","Äìèòðèé", "Åâãåíèé" };
string patronymic[5] = { "Àíäðååâè÷", "Èâàíîâè÷", "Ïåòðîâè÷","Èîàíîâè÷", "Äåíèñcîâ" };
string surnames[5] = { "Ñìèðíîâ", "Ìàñëîâ", "Ñàôîíîâ", "Êóçíåöîâ", "Ãîðáà÷¸â" };
...
private:
    ...
    int hash(string str)
    {
        ...
        double c = size * (a - int(a));	// ñ = 10 * (1245.27 - 1245) == 2.7
        return int(c);	// ñ == 2
    }
